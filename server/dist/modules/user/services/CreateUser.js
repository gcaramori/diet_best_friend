...
let CreateUserService = class CreateUserService {
    constructor(userRepo, hashProvider) {
        this.userRepo = userRepo;
        this.hashProvider = hashProvider;
    }
    execute({ name, email, password, birth }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this.userRepo.findByEmail(email)) {
                throw new ErrorHandler_1.default('Email already in use', 401);
            }
